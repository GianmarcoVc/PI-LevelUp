import { SET_PAGE, GET_GENRES, SET_HISTORY, GET_GAMES_ALL, SET_GAMES_VIEW, SET_GAMES_NOW, GET_GAMES_NAME, GET_GAME_DETAIL, SET_BAR_FILTER } from "../actions";
...
export default (state = initialState, { type, payload }) => {
  switch (type) {
    ...
    case SET_HISTORY:
      let index = state.history.findIndex(e => e === payload)
      if(index > 0){
        let r = state.history.splice(index,1)[0]
